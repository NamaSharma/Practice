...
namespace ClassLibrary1
{
    ...
    public partial class ATMEntities : DbContext
    {
        ...
        public virtual ObjectResult<spNewAccount_Result> spNewAccount(Nullable<long> cardNumber, string name, Nullable<int> pin)
        {
            var cardNumberParameter = cardNumber.HasValue ?
                new ObjectParameter("CardNumber", cardNumber) :
                new ObjectParameter("CardNumber", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spNewAccount_Result>("spNewAccount", cardNumberParameter, nameParameter, pinParameter);
        }
